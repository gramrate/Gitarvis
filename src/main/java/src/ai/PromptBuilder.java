    ...
    public String commandInterpretationPrompt(String userText) {
        return """
                ...
                Примеры reply:
                  ...
                  help: "Могу показать статус, добавить изменения, сохранить коммит, создать ветку, переключиться, отправить в origin и выключиться."
                  exit: "Выключаюсь. Если что — зови, я рядом с git."
